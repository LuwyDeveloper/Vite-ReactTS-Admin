		...
		<Dropdown>
			<DropdownToggle trigger='hover'>
				<Badge color='zinc' variant='soft' className='py-2'>
					<img src={Logo} alt='LuwyDyro' className='size-8' />
					LuwyDyro
				</Badge>
			</DropdownToggle>
			<DropdownMenu placement='bottom'>
				<div className='flex items-center gap-4'>
					<div className='flex grow items-center gap-4'>
						<img src={Logo} alt='LuwyDyro' className='size-12' />
						<div>
							<div className='font-bold'>luwy.dyro</div>
							<div className='text-xs text-zinc-500'>@gmail.com</div>
						</div>
					</div>
					<div className=''>
						<Button
